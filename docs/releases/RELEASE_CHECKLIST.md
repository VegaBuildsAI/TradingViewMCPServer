...
Go to: https://github.com/VegaBuildsAI/TradingViewMCPServer/settings
...
```
https://github.com/VegaBuildsAI/TradingViewMCPServer
```
...
Go to: https://github.com/VegaBuildsAI/TradingViewMCPServer/releases/new
...
**Full Changelog**: https://github.com/VegaBuildsAI/TradingViewMCPServer/compare/v3.3.0...v3.4.0
```
...
1. Go to: https://github.com/VegaBuildsAI/TradingViewMCPServer/actions
