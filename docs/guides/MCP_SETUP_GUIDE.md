...
**Allowed Directories:**
- `/Users/VegaBuildsAI/VSCodestuff` (your main projects)
- `/Users/VegaBuildsAI/Github Forking` (forked repositories)
...
```json
{
    ...
    "args": [
        ...
        "/Users/VegaBuildsAI/VSCodestuff",
        "/Users/VegaBuildsAI/Github Forking"
    ]
}
```
...
- `/Users/VegaBuildsAI/VSCodestuff/TradingViewMCPServer`
...
**Allowed Directory:**
- `/Users/VegaBuildsAI/VSCodestuff` (can access any .db files here)
